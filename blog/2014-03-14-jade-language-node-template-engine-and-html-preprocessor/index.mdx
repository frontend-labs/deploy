...
layout: post
path: "/70--jade-language-node-template-engine-and-html-preprocessor"
...
Jade es un motor de plantillas de alto rendimiento muy influenciado por **HAML**, ha sido implementado con [**Javascript**](/tag/javascript/) para trabajar con [NodeJS](/tag/nodejs/).

Adicionalmente es un pre-procesador de código [HTML](/tag/html/).
...
Si no tienes instalado NodeJs para poder usar Jade Language en linux puedes pasar por nuestro post [Como instalar Nodejs en Debian Linux](/232--como-instalar-nodejs-debian-linux).